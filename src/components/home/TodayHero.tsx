...
export function TodayHero({ headline, deck, sources, timeAgo, formattedDate }: TodayHeroProps) {
    ...
    <main className="flex-1 flex flex-col">
      ...
      <div className="w-full">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible" transition={t(0)}>
          ...
          <p className="mt-5 font-sans font-normal text-[15px] sm:text-[17px] leading-[1.55] text-[#525252] max-w-[560px]">
      ...
      >
        {/* Overlay oscuro sobre el wallpaper */}
        <div className="absolute inset-0 bg-black/50" />

        {/* Mac window — interactiva, clamped al container */}
        <div className="relative h-full max-w-[1280px] mx-auto px-6 sm:px-10 py-20 sm:py-24">
          <MacWindow
            headline={headline}
            deck={deck}
            sources={sources}
